...
import com.mohammed.tcmc.ComerBem.helper.Base64Custom;
...
public class SendImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgehome = (ImageView) findViewById( R.id.imgehome );
    ...
    public void salvarUsuarioDB(){
        ...
        filepath.putFile(img_uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(SendImageActivity.this, R.string.não_carregou, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void connection() {
        ...
        mDatabase = database.getReference("chat/messages");
